...
final class Solution {
    ...
    /**
     * resizes the array if the size os equal to the length of array.
     *
     * @param      item  The item
     */
     ...
     */
    /**
     * Removes the element from the index specified.
     *
     * @param      index                     The index
     *
     * @throws     InvalidPositionException  raises the exception.
     */
     ...
     * @param      index  The index
     *
     * @return     gives the element at the given index.
     */
     ...
     * @param      item  The item
     *
     * @return     gives the index of the item.
     */
    ...
    /*
    Inserts all the elements of the given array.
    */
    /**
    ...
    */
    /**
     * Gives a sublist from the start index to end index.
     *
